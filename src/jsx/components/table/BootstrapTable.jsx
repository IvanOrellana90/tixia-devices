      ...
      <Row>
        <Col lg={12}>
          <Card>
            ...
            <Card.Body>
              <Table responsive className="table-responsive-md">
                <thead>
                  <tr>
        ...
        <Col lg={12}>
          <Card>
            ...
            <Card.Body>
              <Table responsive className="table-responsive-sm">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Name</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <Badge bg="" className="light badge-primary">
                        Sale
                      </Badge>
                    </td>
                    <td>January 22</td>
        ...
        <Col lg={12}>
          <Card>
            ...
            <Card.Body>
              <Table responsive striped className="table-responsive-sm">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Name</th>
              ...
              <Table responsive bordered className="verticle-middle">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>May 18,2018</td>
                    <td>
                      <Badge bg="" className="light badge-dark">
                        70%
                      </Badge>
                    </td>
                    <td>
              ...
              <Table responsive className="header-border ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>$245.30</td>
                    <td>
                      <Badge bg="" className="light badge-info">
                        Shipped
                      </Badge>
                    </td>
                    <td>CN</td>
