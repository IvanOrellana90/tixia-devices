            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-body">
                  ...
                  <p>
                    Download the current settings and prompts as a json file.
                  </p>
            ...
            <div className="col-xl-6">
              <div className="card">
                <div className="card-body">
                  ...
                  <p>
                    Upload a settings json file to import settings and/or
                    prompts.
                  </p>
                  <div className="dz-default mb-3">
                    <form
                      action="#"
                      className="dropzone upload-img text-center"
                    >
                      <svg
                        width="41"
                        height="40"
                    ...
                    <small>
                      <strong className="text-black">Important:</strong> It's
                      highly recommended to backup your current settings before
                      importing new settings, so you can revert back if needed.
                    </small>
                  </div>
