        ...
        <div className="col-xl-12">
          ...
          <div className="card h-auto">
            <div className="card-body border-0 pb-0">
              ...
              <p>
                Adjust the plugin to your needs by editing the settings here.
              </p>
              <div className="row">
                <div className="col-xl-6 col-sm-6">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      placeholder="this-is-a-secret-key"
                    />
                    <div id="emailHelp" className="form-text">
                      For instructions on how to get an OpenAI key, please visit
                      <Link to={'#'} className="text-primary">
                        {' '}
                        https://getaikit.com/docs/getting-started
                      </Link>
                    </div>
                  </div>
                </div>
                <div className="col-xl-6 col-sm-6">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      placeholder="this-is-rapid-api-key"
                    />
                    <div id="emailHelp-1" className="form-text">
                      Enter your RapidAPI key for Subtitles for YouTube here.
                      This API is used to read YouTube video subtitles to allow
                      you to fetch.
                      <Link to={'#'} className="text-primary">
                        Read More
                        <ToolTipBlog />
                ...
                <div className="col-xl-3 col-sm-6">
                  ...
                  <div className="mb-3">
                    <Select
                      ...
                      isSearchable={false}
                    />
                    <div id="emailHelp-2" className="form-text">
                ...
                <div className="col-xl-3 col-sm-6">
                  ...
                  <div id="emailHelp-6" className="form-text mb-2">
                    AIKit's builtin prompts are already.
                    <Link to={'#'} className="text-primary">
                      Read More
                      <ToolTipBlog />
                    </Link>
                ...
                <div className="col-xl-3 col-sm-6">
                  ...
                  <div id="emailHelp-7" className="form-text mb-2">
                    The language of the text you want to generate.
                    <Link to={'#'} className="text-primary">
                      Read More
                      <ToolTipBlog />
                ...
                <div className="col-xl-3 col-sm-6">
                  ...
                  <div id="emailHelp-8" className="form-text mb-2">
                    When this is enabled, you will be able to use AIKit right.
                    <Link to={'#'} className="text-primary">
                      Read More
                      <ToolTipBlog />
                    </Link>
                ...
                <div className="col-xl-3 col-sm-6 align-self-end">
                  ...
                  <div id="emailHelp-9" className="form-text mb-2">
                    When this is enabled, you will be able to use AIKit right.
                    <Link to={'#'} className="text-primary">
                      Read More
                      <ToolTipBlog />
                ...
                <div className="col-xl-3 col-sm-6 align-self-end">
                  ...
                  <div id="emailHelp-10" className="form-text mb-2">
                    When this is enabled, you will be able to use AIKit right.
                    <Link to={'#'} className="text-primary">
                      Read More
                      <ToolTipBlog />
                ...
                <div className="col-xl-6">
                  <div className="mb-3 taginput-data">
                    ...
                    <TagInput block defaultValue={initialTags} />
                    <div id="emailHelp-11" className="form-text mb-2">
                      System message help set the behaviour of the model. You
                      can use it to ask the model to mimic a certain style or
                      take a certain perspective for all text generations. For
                      example, if you set this to "Shakespeare' style", the mode
                      will follow the style of Shakespeare in all text
                      generations when possible. System message should work ONLY
                      with GPT-4 and to a lesser extent with gpt-3.5-turbo
                      models.
                    </div>
                  </div>
                </div>
                <div className="col-xl-6">
                  ...
                  <div className="form-floating">
                    <textarea
                      ...
                      id="floatingTextarea"
                    ></textarea>
                    <div id="emailHelp-12" className="form-text mb-2">
                      System message help set the behaviour of the model. You
                      can use it to ask the model to mimic a certain style or
                      take a certain perspective for all text generations. For
                      example, if you set this to "Shakespeare' style", the mode
