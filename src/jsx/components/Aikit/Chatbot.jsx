...
// import { IMAGES } from '../../content/theme.jsx';
              ...
              <div className="row">
                <div className="col-xl-2">
                  ...
                  <div className="btn-group d-block" role="group">
                    ...
                    />
                    <label
                      className="btn btn-outline-primary btn-sm rounded ms-2"
                      htmlFor="btnradio2"
                    >
                      No
                    </label>
                ...
                <div className="col-xl-4">
                  ...
                  <div className="mb-3">
                    ...
                    <div id="emailHelp" className="form-text">
                      For best results, please use chat models like
                ...
                <div className="col-xl-6">
                  <div className="mb-3">
                    ...
                    <div id="emailHelp-1" className="form-text">
                      Please set this only if you are using a fine-tuned model.
                      Leave empty if you are using any of the built-in models.
                      Completion stop sequence is used to mark the stop of the
                      completion.
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-12">
                  <div className="mb-3">
                    ...
                    <div id="emailHelp-3" className="form-text">
                      You can use this field to set the behaviour of the
                      chatbot. For example, use something like "You are a
                      helpful assistant." or "Answer in the style of
                      Shakespeare."
                    </div>
                  </div>
                  <label className="form-label">
                    Show Chatbot only for user role
                  </label>
                  <div className="mb-3">
                    <Select
                      options={options4}
                  ...
                  <div id="emailHelp-4" className="form-text">
                    If enabled, the chatbot will be able to use the content of
                    the current page to generate better responses. Important: it
                    will increase your API costs!
                  </div>
                </div>
              </div>
            </div>
