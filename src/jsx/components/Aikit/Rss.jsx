                    ...
                    <div className="col-xl-12">
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          placeholder="https://yogacare.dexignzone.com/"
                        />
                      </div>
                      <div className="mb-3">
                        <label
                          ...
                          className="form-label"
                        >
                          Time to wait between generating articles (minutes)
                        </label>
                        <input
                          type="number"
                          className="form-control"
                      ...
                      <label className="form-label">
                        How often to check for new articles in RSS feed
                      </label>
                      <div className="mb-3">
                        <Select
                          options={options3}
