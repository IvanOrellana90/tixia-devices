...
// import { IMAGES, SVGICON } from '../../content/theme.jsx';

import England from '../../../assets/images/svg/england.svg';
import IndiaFlag from '../../../assets/images/svg/india.svg';
import Arab from '../../../assets/images/svg/united-arab-emirates.svg';
...
const data = [
  { icon: England, value: 1, label: 'England' },
  { icon: IndiaFlag, value: 2, label: 'India' },
  { icon: Arab, value: 3, label: 'UAE' },
];
                  ...
                  <div className="row">
                    <div className="col-xl-12">
                      ...
                      <div className="mb-3">
                        ...
                        >
                          Write a brief description of the topic you want to
                          write about...
                        </label>
                        <input
                          type="text"
                      ...
                      />
                      <div
                        className="btn-group d-block card-length"
                        role="group"
                      >
                        <input
                          type="checkbox"
                        ...
                        />
                        <label
                          className="btn btn-outline-primary  form-label btn-sm rounded me-1"
                          htmlFor="btncheck1"
                        >
                          Include outline
                        </label>{' '}
                        ...
                        <label
                          ...
                          htmlFor="btncheck4"
                        >
                          Include featured article Image3
                        </label>{' '}
                        <input
                          type="checkbox"
                          className="btn-check"
                        ...
                        />
                        <label
                          className="btn btn-outline-primary  form-label btn-sm rounded"
                          htmlFor="btncheck5"
                        >
                ...
                <div className="card-footer border-0">
                  <div className="text-center">
                    ...
                    <Link to={'#'} className="btn btn-primary">
                      ...
                      >
                        <path
                          d="M11.1498 15.1013H7.30563L6.86828 12.8455H4.15205L3.71469 15.1013H0.0546875L2.67883 0.806641H8.52563L11.1498 15.1013ZM6.43092 10.1523L5.62526 5.04211H5.46413L4.65847 10.1523H6.43092Z"
                          fill="white"
                        />
                        <path
                          d="M16.4903 0.806641H12.5771V15.1013H16.4903V0.806641Z"
                          fill="white"
                        />
                      </svg>{' '}
                      Generate
              ...
              <Accordion className="writer-accordion">
                <Accordion.Item>
                  <Accordion.Header className="accordion-header bg-white rounded-lg">
                    ...
                    <span className="accordion-header-text fw-semibold">
                      Prompts
                    </span>
                  ...
                  <Accordion.Collapse id="collapseOne" className="collapse">
                    <div className="accordion-body-text">
                      <div className="d-flex align-items-center mb-1">
                        ...
                        <span className="badge badge-sm badge-danger light ms-1">
                          description
                        </span>
                        ...
                        {tableData.map((item, ind) => (
                          <tr key={ind}>
                            ...
                            <td className="text-primary">
                              This is a test title generation
                            </td>
                            <td>July {ind + 10}, 2024</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
