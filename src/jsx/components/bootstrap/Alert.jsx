          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Alert variant="dark" dismissible show={state.dark}>
                {emojis.error}
                <strong>Error! </strong> You successfully read this important
                alert message.
                <button
                  className="btn-close"
          ...
          <Card>
            ...
            <Card.Body>
              <Alert
                variant="primary"
                dismissible
                show={state.solidprimary}
                className="solid"
              >
                <strong>Welcome! </strong> Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'solidprimary' })}
                ></button>
              </Alert>
              <Alert
                variant="secondary"
                dismissible
                show={state.solidsecondary}
                className="solid"
              >
                <strong>Done! </strong> Your profile photo updated.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'solidsecondary' })}
                ></button>
              </Alert>
              <Alert
                variant="success"
                dismissible
                show={state.solidsucces}
                className="solid"
              >
                <strong>Success!</strong> Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'solidsucces' })}
                ></button>
              </Alert>
              <Alert
                variant="info"
                dismissible
                show={state.solidinfo}
                className="solid"
              >
                <strong>Info! </strong> You have got 5 new email.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'solidinfo' })}
                ></button>
              </Alert>
              <Alert
                variant="warning"
                dismissible
                show={state.solidwarning}
                className="solid"
              >
                <strong>Error! </strong> Something went wrong. Please check.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'solidwarning' })}
                ></button>
              </Alert>
              <Alert
                variant="danger"
                dismissible
                show={state.soliddanger}
                className="solid"
              >
                <strong>Error! </strong> Message sending failed.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddanger' })}
                ></button>
              </Alert>
              <Alert
                variant="dark"
                dismissible
                show={state.soliddark}
                className="solid"
              >
                <strong>Error! </strong> You successfully read this important
                alert message.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddark' })}
                ></button>
              </Alert>
              <Alert
                variant="light"
                dismissible
                show={state.solidlight}
                className="solid"
              >
                <strong>Error! </strong> You successfully read this message..
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'solidlight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              <Alert variant="primary" dismissible show={state.disprimary}>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'disprimary' })}
                ></button>
              </Alert>
              <Alert variant="secondary" dismissible show={state.dissecondary}>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'dissecondary' })}
                ></button>
              </Alert>
              <Alert variant="success" dismissible show={state.dissuccess}>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'dissuccess' })}
                ></button>
              </Alert>
              ...
              <Alert variant="warning" dismissible show={state.diswarning}>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'diswarning' })}
                ></button>
              </Alert>
              <Alert variant="danger" dismissible show={state.disdanger}>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'disdanger' })}
                ></button>
              </Alert>
              ...
              <Alert variant="light" dismissible show={state.dislight}>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'dislight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altprimary' })}
                ></button>
              </Alert>
              <Alert
                variant="secondary"
                dismissible
                show={state.altsecondary}
                className="alert-alt"
              >
                {emojis.done}
                <strong>Done! </strong> Your profile photo updated.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsecondary' })}
                ></button>
              </Alert>
              <Alert
                variant="success"
                dismissible
                show={state.altsuccess}
                className="alert-alt"
              >
                {emojis.success}
                <strong>Success! </strong> Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsuccess' })}
                ></button>
              </Alert>
              <Alert
                variant="info"
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altinfo' })}
                ></button>
              </Alert>
              <Alert
                variant="warning"
                dismissible
                show={state.altwarning}
                className="alert-alt"
              >
                {emojis.error}
                <strong>Error! </strong> Something went wrong. Please check.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altwarning' })}
                ></button>
              </Alert>
              <Alert
                variant="danger"
                dismissible
                show={state.altdanger}
                className="alert-alt"
              >
                {emojis.error}
                <strong>Error! </strong> Message sending failed.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altdanger' })}
                ></button>
              </Alert>
              <Alert
                variant="dark"
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altlight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              <Alert
                variant="primary"
                dismissible
                show={state.altsolidprimary}
                className="solid alert-alt"
              >
                {emojis.welcome}
                <strong>Welcome! </strong> Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsolidprimary' })}
                ></button>
              </Alert>
              <Alert
                variant="secondary"
                dismissible
                show={state.altsolidsecondary}
                className="solid alert-alt"
              >
                {emojis.done}
                <strong>Done! </strong> Your profile photo updated.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsolidsecondary' })}
                ></button>
              </Alert>
              <Alert
                variant="success"
                dismissible
                show={state.altsolidsucces}
                className="solid alert-alt"
              >
                {emojis.success}
                <strong>Success!</strong> Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsolidsuccess' })}
                ></button>
              </Alert>
              <Alert
                variant="info"
                dismissible
                show={state.altsolidinfo}
                className="solid alert-alt"
              >
                {emojis.info}
                <strong>Info! </strong> You have got 5 new email.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsolidinfo' })}
                ></button>
              </Alert>
              <Alert
                variant="warning"
                dismissible
                show={state.altsolidwarning}
                className="solid alert-alt"
              >
                {emojis.error}
                <strong>Error! </strong> Something went wrong. Please check.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsolidwarning' })}
                ></button>
              </Alert>
              <Alert
                variant="danger"
                dismissible
                show={state.altsoliddanger}
                className="solid alert-alt"
              >
                {emojis.error}
                <strong>Error! </strong> Message sending failed.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsoliddanger' })}
                ></button>
              </Alert>
              <Alert
                variant="dark"
                dismissible
                show={state.altsoliddark}
                className="solid alert-alt"
              >
                {emojis.error}
                <strong>Error! </strong> You successfully read this important
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsoliddark' })}
                ></button>
              </Alert>
              <Alert
                variant="light"
                dismissible
                show={state.altsolidlight}
                className="solid alert-alt"
              >
                {emojis.error}
                <strong>Error! </strong> You successfully read this message..
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'altsolidlight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddisprimary' })}
                ></button>
              </Alert>
              <Alert
                variant="secondary"
                dismissible
                show={state.soliddissecondary}
                className="solid"
              >
                {emojis.done}
                <strong>Done! </strong> Your profile photo updated.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddissecondary' })}
                ></button>
              </Alert>
              <Alert
                variant="success"
                dismissible
                show={state.soliddissuccess}
                className="solid"
              >
                {emojis.success}
                <strong>Success!</strong> Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddissuccess' })}
                ></button>
              </Alert>
              <Alert
                variant="info"
                dismissible
                show={state.soliddisinfo}
                className="solid"
              >
                {emojis.info}
                <strong>Info! </strong> You have got 5 new email.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddisinfo' })}
                ></button>
              </Alert>
              <Alert
                variant="warning"
                dismissible
                show={state.soliddiswarning}
                className="solid"
              >
                {emojis.error}
                <strong>Error! </strong> Something went wrong. Please check.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddiswarning' })}
                ></button>
              </Alert>
              <Alert
                variant="danger"
                dismissible
                show={state.soliddisdanger}
                className="solid"
              >
                {emojis.error}
                <strong>Error! </strong> Message sending failed.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddisdanger' })}
                ></button>
              </Alert>
              <Alert
                variant="dark"
                dismissible
                show={state.soliddisdark}
                className="solid"
              >
                {emojis.error}
                <strong>Error! </strong> You successfully read this important
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddisdark' })}
                ></button>
              </Alert>
              <Alert
                variant="light"
                dismissible
                show={state.soliddislight}
                className="solid"
              >
                {emojis.error}
                <strong>Error! </strong> You successfully read this message..
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'soliddislight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
            ...
            <Card.Body>
              <Alert variant="primary" dismissible show={state.linkprimary}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linkprimary' })}
                  ></button>
                </Link>
              </Alert>
              <Alert variant="secondary" dismissible show={state.linksecondary}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linksecondary' })}
                  ></button>
                </Link>
              </Alert>
              <Alert variant="success" dismissible show={state.linksuccess}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linksuccess' })}
                  ></button>
                </Link>
              </Alert>
              <Alert variant="info" dismissible show={state.linkinfo}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linkinfo' })}
                  ></button>
                </Link>
              </Alert>
              <Alert variant="warning" dismissible show={state.linkwarning}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linkwarning' })}
                  ></button>
                </Link>
              </Alert>
              <Alert variant="danger" dismissible show={state.linkdanger}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linkdanger' })}
                  ></button>
                </Link>
              </Alert>
              <Alert variant="dark" dismissible show={state.linkdark}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linkdark' })}
                  ></button>
                </Link>
              </Alert>
              <Alert variant="light" dismissible show={state.linklight}>
                ...
                <Link to={'#'}>
                  ...
                  <button
                    className="btn-close"
                    onClick={() => dispatch({ type: 'linklight' })}
                  ></button>
                </Link>
              </Alert>
            </Card.Body>
          ...
          <Card>
            ...
            <Card.Body>
              <Alert
                variant="primary"
                dismissible
                show={state.linkprimary}
                className="solid"
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link
                  to={'#'}
                  className="badge-sm light ms-1 badge badge-primary"
                >
                  upgrade
                </Link>
                <button
              ...
              <Alert
                variant="secondary"
                dismissible
                show={state.linksecondary}
                className="solid"
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link
                  to={'#'}
                  className="badge-sm light ms-1 badge badge-secondary"
                >
                  upgrade
                </Link>
                <button
              ...
              <Alert
                variant="success"
                dismissible
                show={state.linksuccess}
                className="solid"
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link
                  to={'#'}
                  className="badge-sm light ms-1 badge badge-succes"
                >
                  upgrade
                </Link>
                <button
              ...
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link to={'#'} className="badge-sm light ms-1 badge badge-info">
                  upgrade
                </Link>
                <button
                  className="btn-close"
              ...
              <Alert
                variant="warning"
                dismissible
                show={state.linkwarning}
                className="solid"
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link
                  to={'#'}
                  className="badge-sm light ms-1 badge badge-warning"
                >
                  upgrade
                </Link>
                <button
              ...
              <Alert
                variant="danger"
                dismissible
                show={state.linkdanger}
                className="solid"
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link
                  to={'#'}
                  className="badge-sm light ms-1 badge badge-danger"
                >
                  upgrade
                </Link>
                <button
              ...
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link to={'#'} className="badge-sm light ms-1 badge badge-dark">
                  upgrade
                </Link>
                <button
                  className="btn-close"
              ...
              <Alert
                variant="light"
                dismissible
                show={state.linklight}
                className="solid"
              >
                <strong>WOW! Eveything looks OK. </strong>
                <Link
                  to={'#'}
                  className="badge-sm light ms-1 badge badge-light"
                >
                  upgrade
                </Link>
                <button
            ...
            <Card.Body>
              <Row>
                ...
                <Col xl={6}>
                  <Alert
                    variant="light"
                    className="fade alert-primary notification show"
                  >
                    <p className="notificaiton-title mb-2">
                      <strong>Success!</strong> Vampires The Romantic Ideology
                      Behind Them
          ...
          <Card>
            ...
            <Card.Body>
              <Alert
                variant="primary"
                dismissible
                show={state.iconprimary}
                className="solid alert-right-icon"
              >
                <span>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'iconprimary' })}
                ></button>
              </Alert>
              <Alert
                variant="secondary"
                dismissible
                show={state.iconsecondary}
                className="solid alert-right-icon"
              >
                <span>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'iconsecondary' })}
                ></button>
              </Alert>
              <Alert
                variant="success"
                dismissible
                show={state.iconsuccess}
                className="solid alert-right-icon"
              >
                <span>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'iconsuccess' })}
                ></button>
              </Alert>
              <Alert
                variant="info"
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'iconinfo' })}
                ></button>
              </Alert>
              <Alert
                variant="warning"
                dismissible
                show={state.iconwarning}
                className="solid alert-right-icon"
              >
                <span>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'iconwarning' })}
                ></button>
              </Alert>
              <Alert
                variant="danger"
                dismissible
                show={state.icondanger}
                className="solid alert-right-icon"
              >
                <span>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'icondanger' })}
                ></button>
              </Alert>
              <Alert
                variant="dark"
              ...
              >
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'icondark' })}
                ></button>
              </Alert>
              <Alert
                variant="light"
                dismissible
                show={state.iconlight}
                className="solid alert-right-icon"
              >
                <span>
                ...
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'iconlight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
          ...
          <Card>
            ...
            <Card.Body>
              <Alert
                variant="primary"
                dismissible
                show={state.outlineprimary}
                className="alert-outline-primary"
              >
                Welcome! Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlineprimary' })}
                ></button>
              </Alert>
              <Alert
                variant="secondary"
                dismissible
                show={state.outlinesecondary}
                className="alert-outline-secondary"
              >
                Done! Your profile photo updated.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlinesecondary' })}
                ></button>
              </Alert>
              <Alert
                variant="success"
                dismissible
                show={state.outlinesuccess}
                className="alert-outline-success"
              >
                Success! Message has been sent.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlinesuccess' })}
                ></button>
              </Alert>
              <Alert
                variant="info"
                dismissible
                show={state.outlineinfor}
                className="alert-outline-info"
              >
                Info! You have got 5 new email.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlineinfor' })}
                ></button>
              </Alert>
              <Alert
                variant="warning"
                dismissible
                show={state.outlinewarning}
                className="alert-outline-warning"
              >
                Error! Something went wrong. Please check.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlinewarning' })}
                ></button>
              </Alert>
              <Alert
                variant="danger"
                dismissible
                show={state.outlinedanger}
                className="alert-outline-danger"
              >
                Error! Message sending failed.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlinedanger' })}
                ></button>
              </Alert>
              <Alert
                variant="dark"
                dismissible
                show={state.outlinedark}
                className="alert-outline-dark"
              >
                Error! You successfully read this important alert message.
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlinedark' })}
                ></button>
              </Alert>
              <Alert
                variant="light"
                dismissible
                show={state.outlinelight}
                className="alert-outline-light"
              >
                Error! You successfully read this message..
                <button
                  className="btn-close"
                  onClick={() => dispatch({ type: 'outlinelight' })}
                ></button>
              </Alert>
            </Card.Body>
          </Card>
              ...
              <Row>
                <Col xl={6}>
                  <Alert
                    variant="warning"
                    dismissible
                    show={state.socialefacebook}
                    className="facebook alert-social"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'socialefacebook' })}
                    ></button>
                    <div className="media">
                ...
                <Col xl={6}>
                  <Alert
                    variant="warning"
                    dismissible
                    show={state.socialtwitter}
                    className="twitter alert-social"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'socialtwitter' })}
                    ></button>
                    <div className="media">
                      <div className="alert-social-icon">
                        <span>
                ...
                <Col xl={6}>
                  <Alert
                    variant="warning"
                    dismissible
                    show={state.sociallinkdin}
                    className="linkedin  alert-social"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'sociallinkdin' })}
                    ></button>
                    <div className="media">
                      <div className="alert-social-icon">
                        <span>
                ...
                <Col xl={6}>
                  <Alert
                    variant="warning"
                    dismissible
                    show={state.socialgoogle}
                    className="google-plus alert-social"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'socialgoogle' })}
                    ></button>
                    <div className="media">
                      <div className="alert-social-icon">
                        <span>
              ...
              <Row>
                <Col xl={6}>
                  <Alert
                    variant="primary"
                    dismissible
                    show={state.messageprimary}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messageprimary' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                ...
                <Col xl={6}>
                  <Alert
                    variant="secondary"
                    dismissible
                    show={state.messagesecondary}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messagesecondary' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-1">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="success"
                    dismissible
                    show={state.messagesuccess}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messagesuccess' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-1">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="info"
                    dismissible
                    show={state.messageinfo}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messageinfo' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-1">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="warning"
                    dismissible
                    show={state.messagewarning}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messagewarning' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-1">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="danger"
                    dismissible
                    show={state.messagedanger}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messagedanger' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-1">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="dark"
                    dismissible
                    show={state.messagedark}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messagedark' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-1">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="light"
                    dismissible
                    show={state.messagelight}
                    className=""
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'messagelight' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-1">Notifications</h5>
              ...
              <Row>
                <Col xl={6}>
                  <Alert
                    variant="primary"
                    dismissible
                    show={state.solidmessageprimary}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessageprimary' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                ...
                <Col xl={6}>
                  <Alert
                    variant="secondary"
                    dismissible
                    show={state.solidmessagesecondary}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                ...
                <Col xl={6}>
                  <Alert
                    variant="success"
                    dismissible
                    show={state.solidmessagesuccess}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessagesuccess' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-2 text-white">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="info"
                    dismissible
                    show={state.solidmessageinfo}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessageinfo' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-2 text-white">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="warning"
                    dismissible
                    show={state.solidmessagewarning}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessagewarning' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-2 text-white">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="danger"
                    dismissible
                    show={state.solidmessagedanger}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessagedanger' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-2 text-white">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="dark"
                    dismissible
                    show={state.solidmessagedark}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessagedark' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
                        <h5 className="mt-1 mb-2 text-white">Notifications</h5>
                ...
                <Col xl={6}>
                  <Alert
                    variant="light"
                    dismissible
                    show={state.solidmessagelight}
                    className="solid"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'solidmessagelight' })}
                    ></button>
                    <div className="media">
                      <div className="media-body">
              ...
              <Row>
                <Col xl={6}>
                  <Alert
                    variant="primary"
                    dismissible
                    show={state.iconbigprimary}
                    className="left-icon-big"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'iconbigprimary' })}
                    ></button>
                    <div className="media">
                ...
                <Col xl={6}>
                  <Alert
                    variant="warning"
                    dismissible
                    show={state.iconbigwarning}
                    className="left-icon-big"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'iconbigwarning' })}
                    ></button>
                    <div className="media">
                      <div variant="" className="alert-left-icon-big">
                        <span>
                ...
                <Col xl={6}>
                  <Alert
                    variant="success"
                    dismissible
                    show={state.iconbigsuccess}
                    className="left-icon-big"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'iconbigsuccess' })}
                    ></button>
                    <div className="media">
                      <div variant="" className="alert-left-icon-big">
                        <span>
                ...
                <Col xl={6}>
                  <Alert
                    variant="danger"
                    dismissible
                    show={state.iconbigdanger}
                    className="left-icon-big"
                  >
                    <button
                      className="btn-close"
                      onClick={() => dispatch({ type: 'iconbigdanger' })}
                    ></button>
                    <div className="media">
                      <div variant="" className="alert-left-icon-big">
                        <span>
