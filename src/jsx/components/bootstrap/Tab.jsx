        ...
        <Col xl={6}>
          <Card>
            ...
            <Card.Body>
              <Row>
                <Tab.Container defaultActiveKey={tabData[0].name.toLowerCase()}>
                  <Col xl={3} className="col-xxl-4 col-sm-4">
                    <Nav as="ul" className="flex-column mx-0 nav-pills mb-3">
                      {tabData.map((data, i) => (
                        <Nav.Item as="li" key={i}>
                          <Nav.Link eventKey={data.name.toLowerCase()}>
                            {data.name}
                  ...
                  <Col xl={9} className="col-xxl-8 col-sm-8">
            ...
            <Card.Body>
              <Row>
                <Tab.Container defaultActiveKey={tabData[0].name.toLowerCase()}>
                  ...
                  <Col xl={3} className="col-xxl-4 col-sm-4" id="order-2">
                    <Nav as="div" variant="pills" className="flex-column mx-0">
                      {tabData.map((data, i) => (
                        <Nav.Item as="a" key={i}>
                          <Nav.Link eventKey={data.name.toLowerCase()}>
                            {data.name}
