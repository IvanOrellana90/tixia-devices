          ...
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                ...
                <Badge bg="" className="badge-light">
                  Light
                </Badge>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                ...
                <Badge bg="light" className="badge-light">
                  Light
                </Badge>
          ...
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                ...
                <Badge pill bg="light" className="badge-light">
                  Pill badge
                </Badge>
                <Badge pill bg="dark">
                  Pill badge
          ...
          <Card>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                ...
                <Badge as="a" href="" bg="" className="badge-light">
                  Links
                </Badge>
            ...
            <Card.Body>
              <div className="bootstrap-badge">
                ...
                <Badge
                  ...
                  href=""
                  bg=""
                  className="badge-outline-light badge-light"
                >
                  7
                </Badge>
