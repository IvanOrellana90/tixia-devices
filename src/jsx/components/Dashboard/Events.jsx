...
//Images
import cardpng from '../../../assets/images/card/4.png';
              ...
              <div className="card">
                <div className="card-header border-0">
                  ...
                  <Dropdown className="btn-group">
                    ...
                    <Dropdown.Menu className="dropdown-right" align="end">
          ...
          <div className="row">
            <div className="col-xl-12 ">
              <div className="card event-bx">
                <div className="card-media">
                  <img className="rounded" src={cardpng} alt="card" />
                  <div className="overlay-bx row p-3 p-xl-4">
                    <div className="col-lg-6 col-10 p-0">
                      <h3 className="text-white mb-4">
                        Beautiful Fireworks Show In The New Year Night 2024.
                      </h3>
                      <Link
                    ...
                    <div className="col-lg-6 p-0 d-flex align-items-end justify-content-end">
                      <Dropdown className="dropdown ms-3">
                        <Dropdown.Toggle
                          type="button"
                          className="btn rounded border-white p-2 icon-false"
                          variant=""
                        >
                          <svg
                            width={24}
                ...
                <div className="card-body">
                  <div className="row align-items-center">
                    <div className="col-xl-8 col-xxl-8">
                      <div className="border-xl-end pe-xl-4 pe-lg-2">
                        <h4 className="text-black">Event Description</h4>
                        <p>
                          Lorem Ipsum is simply dummy text of the printing and
                          typesetting industry. Lorem Ipsum has been the
                          industry's standard dummy text ever since the 1500s,
                          when an unknown printer took a galley of type and
                          scrambled it to make a type specimen book. text ever
                    ...
                    <div className="col-xl-4 col-xxl-4">
                      <div className="media mb-3 align-items-center">
                        ...
                        <div className="media-body">
                          <p className="mb-0">Ticket Price</p>
                          <h5 className="mb-0 text-black">$124,00</h5>
                        </div>
                      </div>
                      <div className="media mb-3 align-items-center">
                        <div className="me-3">
            ...
            <div className="col-xl-12">
              <div className="card bg-transparent shadow-none">
                <div className="card-header ps-0 border-0 p-0 mb-3">
                  <h4 className="card-title">Recent Sales</h4>
                </div>
                <div className="card-body p-0 bg-white rounded shadow">
                  <div className="table-responsive">
                    <table className="table fs-14 table-responsive-md mb-0">
                      <thead>
                        <tr>
                          <th>Order ID</th>
                          <th>Date</th>
