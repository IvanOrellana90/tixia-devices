...
const Invoice = () => {
  return (
    <Fragment>
      <PageTitle motherMenu="Shop" activeMenu="Invoice" />
      <div className="row">
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              {' '}
              Invoice <strong>01/12/2024</strong>{' '}
                ...
                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-4 d-flex justify-content-lg-end justify-content-md-center justify-content-xs-start">
                  <div className="row align-items-center">
                    <div className="col-sm-9">
                      <div className="invoice-logo justify-content-start p-0 mb-3">
                        <img
                          className="logo-abbr me-2"
                          width="50"
                          src={logo}
                          alt="logo"
                        />
                    ...
                    <div className="col-sm-3 mt-3">
                      {' '}
                      <img src={QrCode} className="img-fluid width110" />{' '}
                    </div>
                  </div>
                </div>
              </div>
