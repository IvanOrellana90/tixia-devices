    ...
    <Fragment>
      ...
      >
        ...
        <div className="modal-body">
          <textarea
            ...
            defaultValue={''}
          />
          <Link className="btn btn-primary btn-rounded mt-1" to="/app-profile">
            Post
          </Link>
        </div>
      </Modal>
      ...
      >
        <div className="modal-content">
          ...
          <div className="modal-body">
            <Link
              className="btn-social my-sm-0 my-1 me-1 facebook"
              to="/app-profile"
            >
              <i className="fab fa-facebook-f" />
            </Link>
            <Link
              className="btn-social my-sm-0 my-1 me-1 google-plus"
              to="/app-profile"
            >
              {' '}
            ...
            <Link
              className="btn-social my-sm-0 my-1 me-1 linkedin"
              to="/app-profile"
            >
              <i className="fab fa-linkedin-in" />
            </Link>
            <Link
              className="btn-social my-sm-0 my-1 me-1 instagram"
              to="/app-profile"
            >
              {' '}
