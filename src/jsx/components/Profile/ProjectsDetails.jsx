      ...
      <div className="tab-content" id="tabContentMyProfileBottom">
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <div className="d-flex align-items-center">
            <Link to="/profile/projects" className="btn-link ms-2">
              More Project
            </Link>
          </div>
        </div>
              ...
              <div className="card-body">
                <div className="row align-items-center">
                  <div className="col-sm-6 mb-3">
                    <div
                      id="chartTasksSummary"
                      className="project-chart d-flex justify-content-center"
                    >
                      <ProjectStatusChart />
                    </div>
                  </div>
                  <div className="col-sm-6 mb-3">
                    <div className="d-flex justify-content-between mb-3">
                      <div className="text-black">
                        <i className="fa-solid fa-square text-primary me-1"></i>{' '}
                        Employee
                      </div>
                      <span>25</span>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      <div className="text-black">
                        <i className="fa-solid fa-square text-success me-1"></i>{' '}
                        Present
                      </div>
                      <span>17</span>
                    </div>
                    <div className="d-flex justify-content-between mb-3">
                      <div className="text-black">
                        <i className="fa-solid fa-square text-danger me-1"></i>{' '}
                        Absent
                      </div>
                      <span>20</span>
                    </div>
                    <div className="d-flex justify-content-between">
                      <div className="text-black">
                        <i className="fa-solid fa-square text-warning me-1"></i>{' '}
                        Holiday
                      </div>
                      <span>38</span>
                    </div>
                ...
                <div className="alert alert-outline-light outline-dashed p-3 mb-0">
                  ...
                  to creating great outstanding business to business .jsp modutr
                  class scripts
                </div>
              </div>
            </div>
                  ...
                  <div className="clearfix d-flex">
                    <div className="chart-series me-3" id="seriesIncomplete">
                      ...
                      <input
                        className="d-none"
                        type="checkbox"
                        id="checkSeriesIncomplete"
                        name="chart-series"
                        value="Incomplete"
                        onClick={() => handleSeries('Incomplete')}
                      />
                      <label className="mb-0" htmlFor="checkSeriesIncomplete">
                        {' '}
                        Incomplete
                      </label>
                    </div>
                    <div className="chart-series" id="seriesComple">
                      ...
                      <input
                        className="d-none"
                        type="checkbox"
                        id="checkSeriesComple"
                        name="chart-series"
                        value="Complete"
                        onClick={() => handleSeries('Complete')}
                      />
                      <label className="mb-0" htmlFor="checkSeriesComple">
                        {' '}
                        Comple
                      </label>
                    </div>
                ...
                <Dropdown className="">
                  ...
                  >
                    <Dropdown.Item
                      ...
                      onClick={() => setControl('2020')}
                    >
                      2020
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => setControl('2021')}>
                      2021
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => setControl('2022')}>
                      2022
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => setControl('2023')}>
                      2023
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => setControl('2024')}>
                      2024
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
