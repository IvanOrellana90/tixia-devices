      ...
      <div className="card card-comment">
        <div className="card-body pb-0">
          ...
          <div className="d-flex py-2 position-relative">
            ...
            <div className="clearfix ms-2">
              <h6 className="fs-13 mb-1 fw-semibold">
                Mr. Hamilton{' '}
                <span className="fs-12 text-muted ms-1 fw-normal">
                  2 Day ago
                </span>
              </h6>
            ...
            <Link to={'#'} className="position-absolute end-0 top-0">
              Reply
            </Link>
          </div>
          <div className="d-flex py-2 position-relative">
          ...
          <div className="position-relative border-top border-secondary border-opacity-10 d-flex align-items-center mt-3">
            <input
              type="text"
              className="form-control p-0 rounded-0 border-0 pe-2 bg-transparent"
              placeholder="Reply.."
            />
