          ...
          <div className="row">
                    ...
                    <div className="cm-content-body form excerpt">
                      <div className="card-body">
                        ...
                        <span className="mt-3 d-block">
                          Custom fields can be used to extra metadata to a post
            ...
            <div className="col-xl-4 col-xxl-12">
              ...
              {!state.section7 && (
                <div className="filter cm-content-box box-primary">
                  <div className="content-title">
                    <div className="cpa">Categories</div>
                    <div className="tools">
                      <Link
                        to={'#'}
                  ...
                  <Collapse in={!state.collpase4}>
                    <div className="cm-content-body publish-content form excerpt">
                      <div className="card-body">
                        ...
                        <Link to={'#'}>
                          <i className="fas fa-plus"></i> Add New Categories
                        </Link>
