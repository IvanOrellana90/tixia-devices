...
export default function CustomerChat() {
  ...
  return (
    <Fragment>
      <PageTitle motherMenu={'Customer'} activeMenu={'Chats'} />
      <div className="row">
        <div className="col-xl-3 col-xxl-5  chat-left-area">
          <div className="card dz-scroll chat-sidebar mb-0" id="chat-sidebar">
            <div className="card-body">
              ...
              <div className="chat-people">
                ...
                <ul className="d-flex align-items-center justify-content-between mt-2 contact-list">
                  {ChatImageData.map((elem, ind) => (
                    <li key={ind}>
                      <img src={elem.image} alt="avat1" />
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="chat-tabs">
                ...
                <div className="course-details-tab style-2">
                  <ul>
                    {chatDataList.map((elem, ind) => (
                      <li
                        className={`chat-bx ${chatActive === elem.id ? 'active' : ''}`}
                        key={ind}
                        onMouseEnter={() => setChatActive(elem.id)}
                      >
                        <div className="chat-img">
                          <img src={elem.chatImg} alt="gh" />
                        </div>
              ...
              <div className="chat-tabs">
                ...
                <div className="course-details-tab style-2">
                  <ul>
                    {chatDataList2.map((elem, ind) => (
                      <li className="chat-bx chats" key={ind}>
                        <div className="chat-img">
                          <img src={elem.chatImg} alt="pro" />
                        </div>
                        <div className="mid-info">
                          <h6 className="name">{elem.name}</h6>
                          <span>{elem.message}</span>
          ...
          <div className="message-box style-1 d-flex align-items-center flex-wrap">
            ...
            <div className="chat-hamburger">
              ...
              <Dropdown className="dropdown custom-dropdown mb-0">
                <Dropdown.Toggle className="btn sharp btn-primary tp-btn icon-false">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18px"
                    height="18px"
            ...
            <div className="chat-box-area dlab-scroll" id="chartBox">
              <div className="media my-4">
                <div className="dz-media">
                  <img src={IMAGES.Avat5} alt="as" />
                </div>
                <div className="message-received w-auto">
                  <h5>Jordan</h5>
                  <div>
                    <p className="mb-2">Hello Nella!</p>
                  </div>
                  <div>
                    <p className="mb-2">
              ...
              <div className="media mb-4 justify-content-end align-items-start">
                <div className="message-sent w-auto">
                  <h5>Natasha</h5>
                  <div>
                    <p className="mb-2">Hello Karen!</p>
              ...
              <div className="media mb-4 justify-content-end align-items-start">
                ...
                <div className="dz-media ms-2">
                  <img src={IMAGES.Avat2} alt="file" />
                </div>
              </div>
              <div className="media my-4">
                <div className="dz-media">
                  <img src={IMAGES.Avat3} alt="pro" />
                </div>
                <div className="message-received w-auto">
                  <h5>Jordan</h5>
                  <div>
      ...
      <Modal show={addContact} onHide={setAddContact} centered>
        <div className="modal-content">
          ...
          <div className="modal-body">
            <div className="mb-3">
              <label className="form-label required">Enter Name</label>
              <input type="text" className="form-control" placeholder="Name" />
            </div>
            <div className="mb-3">
              <label className="form-label required">Enter Position</label>
              <input
                type="text"
                className="form-control"
