      ...
      <div className="row">
            ...
            <div className="card-body">
              <div className="basic-form">
                <form onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="form-group row">
                    <label className="col-sm-3 form-label">Password</label>
                    <div className="col-sm-9">
                      <input
                        type="password"
                        className="form-control"
                  ...
                  <fieldset className="form-group">
                    <div className="row">
                      <label className="form-label col-sm-3 pt-0">Radios</label>
                      <div className="col-sm-9">
                        <div className="form-check">
                          <input
                            className="form-check-input"
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="form-group mb-0">
                    <input
                      ...
                      className="form-check-input"
                    />
                    <label className="radio-inline me-3 form-check-label">
                      Option 1
                    </label>
                    <input
                      type="radio"
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="basic-form">
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="form-group row">
                    <label className="col-sm-2 form-label col-form-label col-form-label-sm">
                      Email
                    </label>
                    <div className="col-sm-10">
                      <input
                  ...
                  <div className="form-group row">
                    <label className="col-sm-2 form-label col-form-label">
                      Email
                    </label>
                    <div className="col-sm-10">
                      <input
                  ...
                  <div className="form-group row">
                    <label className="col-sm-2 form-label col-form-label col-form-label-lg">
                      Email
                    </label>
                    <div className="col-sm-10">
                      <input
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="row align-items-center">
                    <div className="col-auto">
                      <label className="form-label sr-only">Name</label>
                      <input
                        type="text"
                    ...
                    <div className="col-auto">
                      <label className="form-label sr-only">Username</label>
                    ...
                    <div className="col-12">
                      <button
                        type="submit"
                        className="btn btn-primary mb-2 mt-sm-2"
                      >
                        Submit
                      </button>
                    </div>
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="row align-items-center">
                    <div className="col-auto my-1">
                      <label className="me-sm-2 form-label">Preference</label>
                      <select
                        defaultValue={'option'}
        ...
        <div className="col-xl-6 col-lg-12">
          <div className="card">
            ...
            <div className="card-body">
              <div className="basic-form custom-select">
                <form>
                  <div className="input-group mb-3">
                    <label className="form-label input-group-text mb-0">
                      Options
                    </label>
                    <select
                      defaultValue={'option'}
                  ...
                  <div className="input-group mb-3">
                    ...
                    <label className="input-group-text form-label mb-0">
                      Options
                    </label>
                  </div>
