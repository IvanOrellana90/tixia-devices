...
import ProfileProgress from '../../Profile/Profile/ProfileProgress';
...
const ProfilePages = [
  ...
  { pagename: 'API Keys', pageurl: 'api-keys' },
          ...
          <div className="clearfix pe-md-5">
            ...
            <ul className="d-flex flex-wrap fs-6 align-items-center">
              <li className="me-3 d-inline-flex align-items-center">
                <i className="las la-user me-1 fs-18"></i>Web Designer
              </li>
              <li className="me-3 d-inline-flex align-items-center">
                <i className="las la-map-marker me-1 fs-18"></i>420 City Path,
                AU 123-456
              </li>
              <li className="me-3 d-inline-flex align-items-center">
                <i className="las la-envelope me-1 fs-18"></i>info@gmail.com
              </li>
            </ul>
            <div className="d-md-flex d-none flex-wrap">
              {earningBlog.map((data, ind) => (
                <div
                  className="border outline-dashed rounded p-2 d-flex align-items-center me-3 mt-3"
                  key={ind}
                >
          ...
          <div className="clearfix mt-3 mt-xl-0 ms-auto d-flex flex-column col-xl-3">
            ...
            <div className="mt-auto d-flex align-items-center">
              <div className="clearfix me-3">
                <span className="fw-medium text-black d-block mb-1">
                  Progress
                </span>
        ...
        >
          {ProfilePages.map((ele, ind) => (
            <li className="nav-item ms-1" key={ind}>
              <Link
                to={`/account/${ele.pageurl}`}
                className={`nav-link py-3 border-3 text-dark ${activePage === ele.pageurl ? 'active' : ''}`}
              >
                {ele.pagename}
              </Link>
            </li>
