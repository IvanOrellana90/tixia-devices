...
import ReferralsTable from './Account/ReferralsTable';
              ...
              <div className="card-body">
                <div className="row mb-3">
                  <div className="col-lg-6 mb-3">
                    ...
                    <p className="fs-14">
                      Elevate your post: Integrate images for impact, smooth
                      flow, humor, and clarity on complex subjects
                    </p>
                  ...
                  <div className="col-lg-6 mb-3">
                    ...
                    <p className="fs-14">
                      Craft your blog post: Choose a topic, outline, research,
                      and fact-check diligently
                    </p>
                    <div className="select-text-wrap">
                      <div className="text-select-copy border border-secondary border-opacity-10 px-3 py-2 rounded mb-3 text-primary">
                        https://dexginlab.com/reffer/
                      </div>
                      <button
                        type="button"
                        className="btn btn-light btn-select-text"
                      >
                        Copy Link
                      </button>
                    </div>
                  ...
                  {balanceSheet.map((ele, ind) => (
                    <div className="col-lg-3 col-sm-6 mb-3" key={ind}>
                      <div className={`rounded p-3 text-center ${ele.bgColor}`}>
                        ...
                        <span className={`fs-14 ${ele.textColor}`}>
                          {ele.label}
                        </span>
                      </div>
                    </div>
