          ...
          <div className="card">
            ...
            <div className="card-body px-0">
              <div
                style={{ height: '370px' }}
                id="DZ_W_TimeLine"
                className="widget-timeline dz-scroll height370 px-4"
              >
          ...
          <div className="card">
            ...
            <div className="card-body px-0">
              <div
                style={{ height: '370px' }}
                id="DZ_W_TimeLine1"
                className="widget-timeline dz-scroll style-1 height370 px-4"
              >
                <ul className="timeline">
                  <li>
                    <div className="timeline-badge primary"></div>
                    ...
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle
                          ...
                          className=" icon-false p-0 sharp"
                        >
                          <svg
                            width="18px"
                            height="18px"
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle
                          variant=" light"
                          className="icon-false p-0 btn-info sharp"
                        >
                          <svg
                            width="18px"
                            height="18px"
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle
                          variant=" light"
                          className=" icon-false p-0 btn-success sharp"
                        >
                          <svg
                            width="18px"
                            height="18px"
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle
                          type="button"
                          className="btn btn-danger light sharp   icon-false p-0 sharp "
          ...
          <div className="card border-0 pb-0">
            ...
            <div className="card-body px-0">
              <div
                style={{ height: '370px' }}
                id="DZ_W_Todo2"
                className="widget-media dz-scroll height370 px-4"
              >
                <ul className="timeline">
                  <li>
                    <div className="timeline-panel">
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle
                          variant=" light"
                          className=" btn-info icon-false p-0 sharp"
                        >
                          <svg
                            width="18px"
                            height="18px"
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle
                          variant=" light"
                          className=" btn-success icon-false p-0 sharp"
                        >
                          <svg
                            width="18px"
                            height="18px"
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <Dropdown className="dropdown">
                        <Dropdown.Toggle
                          variant=" light"
                          className="btn-danger icon-false p-0 sharp"
                        >
                          <svg
                            width="18px"
                            height="18px"
                ...
                <ul className="timeline">
                  ...
                  <li>
                    <div className="timeline-panel">
                      ...
                      <div className="media-body">
                        <h5 className="mb-0">Do nnt give up the fight.</h5>
                        <small className="text-muted">
                          29 July 2020 - 02:26 PM
                        </small>
                      </div>
          ...
          <div className="card active_users">
            ...
            <div className="card-body pt-0">
              <div className="list-group-flush mt-4">
                <div className="list-group-item bg-transparent d-flex justify-content-between border-0 border-bottom px-0 py-1 font-weight-semi-bold">
                  <p className="mb-0">Top Active Pages</p>
                  <p className="mb-0">Active Users</p>
                </div>
                <div className="list-group-item bg-transparent d-flex justify-content-between border-0 border-bottom px-0 py-2">
      ...
      <div className="row">
        ...
        <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
          <div className="card text-white bg-warning text-black">
            <ul className="list-group list-group-flush">
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Regular Checkups</span>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Dr Theodore Handle :</span>
                <strong className="text-white">Dentist</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Dr Valentino Morose :</span>
                <strong className="text-white">Surgeon</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Dr Fleece Marigold :</span>
                <strong className="text-white">Clinical</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Dr Eric Widget :</span>
