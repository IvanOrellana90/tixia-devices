...
const EventSidebar = ({ activeEvent, isMobile }) => {
  const [value, onChange] = useState(new Date());

  return (
    <div
      className={`event-sidebar dz-scroll ${activeEvent ? (isMobile ? '' : 'active') : ''}`}
      id="eventSidebar"
    >
      ...
      <div className="card shadow-none rounded-0 bg-transparent h-auto">
        ...
        <div className="card-body">
            ...
            <div className="media-body px-0">
              <h6 className="mt-0 mb-3 fs-14">
                <Link className="text-black" to="/events">
                  Live Concert Choir Charity Event 2024
                </Link>
              </h6>
          ...
          <div className="media mb-5 align-items-center event-list">
            ...
            <div className="media-body px-0">
              <h6 className="mt-0 mb-3 fs-14">
                <a className="text-black" href="events">
        ...
        <div className="card-footer justify-content-between border-0 d-flex fs-14">
          ...
          <Link to="#" className="text-primary">
            View more <i className="las la-long-arrow-alt-right scale5 ms-2" />
          </Link>
        </div>
      </div>
      <div className="card shadow-none rounded-0 bg-transparent h-auto mb-0">
        <div className="card-body text-center event-calender">
          <Link to="#" className="btn btn-primary btn-rounded btn shadow">
            + New Event
          </Link>
        </div>
      </div>
