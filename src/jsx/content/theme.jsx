...
import PostImaga8 from '../../assets/images/post/img8.jpg';
...
import Avatar7 from '../../assets/images/avatar/pic7.jpg';
import Avat7 from '../../assets/images/avatar/7.jpg';
import Avatar8 from '../../assets/images/avatar/avatar8.jpg';
import AvatarAvatar7 from '../../assets/images/avatar/avatar7.jpg';
import BlueTick from '../../assets/images/blue-tick.png';
import PostFull1 from '../../assets/images/post/img-full1.jpg';
...
import PostImg4 from '../../assets/images/post/img4.jpg';
import PostImg5 from '../../assets/images/post/img5.jpg';
import PostImg6 from '../../assets/images/post/img6.jpg';
import PostImg7 from '../../assets/images/post/img7.jpg';
import PostFull2 from '../../assets/images/post/img-full2.jpg';
import PostBigImg6 from '../../assets/images/post/img6.jpg';
...
import Twitter from '../../assets/images/logo/large/twitter.png';
import LargeSpotify from '../../assets/images/logo/large/spotify.png';
import Telegram from '../../assets/images/logo/large/telegram.png';
import Pinterest from '../../assets/images/logo/large/pinterest.png';
import LargeGithub from '../../assets/images/logo/large/github.png';
import Youtube from '../../assets/images/logo/large/youtube.png';
import Reddit from '../../assets/images/logo/large/reddit.png';
import Folder from '../../assets/images/files/folder.png';
import HhtmlFile from '../../assets/images/files/html.png';
import PptFile from '../../assets/images/files/ppt.png';

import Screen1 from '../../assets/images/blog/screen1.jpg';
import Screen2 from '../../assets/images/blog/screen2.jpg';
import Screen3 from '../../assets/images/blog/screen3.jpg';
import Upgrade from '../../assets/images/upgrade-light.png';

import CardJpg1 from '../../assets/images/card1.jpg';
import CardJpg2 from '../../assets/images/card2.jpg';
...
export const IMAGES = {
  ...
  Avat7: Avat7,
  Avatar8: Avatar8,
  AvatarAvatar7: AvatarAvatar7,
  PostImaga8: PostImaga8,
...
export const SVGICON = {
  ...
  Refresh: (
    ...
    >
      <g clipPath="url(#clip0_28_2466)">
        ...
        />
        <path
          d="M19.1665 16.667V11.667H14.1665"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M17.0752 7.49998C16.6525 6.30564 15.9342 5.23782 14.9873 4.39616C14.0403 3.55451 12.8956 2.96645 11.6599 2.68686C10.4242 2.40727 9.13787 2.44527 7.92084 2.79729C6.70381 3.14932 5.59579 3.80391 4.70016 4.69998L0.833496 8.33331M19.1668 11.6666L15.3002 15.3C14.4045 16.1961 13.2965 16.8506 12.0795 17.2027C10.8625 17.5547 9.57609 17.5927 8.3404 17.3131C7.10472 17.0335 5.96 16.4455 5.01305 15.6038C4.06611 14.7621 3.3478 13.6943 2.92516 12.5"
          stroke="white"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  YouTube: (
    ...
    >
      ...
      />
      <path
        d="M7.3125 11.7654L11.625 9.31285L7.3125 6.86035V11.7654Z"
        stroke="var(--primary)"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  ArrowUpGreen: (
    ...
    >
      <path
        d="M5.83334 14.1668L14.1667 5.8335"
      ...
      />
      <path
        d="M5.83334 5.8335H14.1667V14.1668"
        stroke="var(--bs-success)"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  ArrowDownRed: (
    ...
    >
      ...
      />
      <path
        d="M14.1667 14.1668H5.83337V5.8335"
        stroke="var(--bs-danger)"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Bulb: (
    ...
    >
      <g clipPath="url(#clip0_58_6049)">
        <path
          d="M11.999 2.8125C11.6107 2.8125 11.2959 3.12731 11.2959 3.51562C11.2959 3.90394 11.6107 4.21875 11.999 4.21875C14.3256 4.21875 16.2185 6.11128 16.2185 8.4375C16.2185 8.82581 16.5333 9.14062 16.9216 9.14062C17.3099 9.14062 17.6247 8.82581 17.6247 8.4375C17.6247 5.33588 15.1011 2.8125 11.999 2.8125Z"
          fill="var(--primary)"
        />
        <path
          d="M10.1871 0.189329C7.01041 0.853126 4.43463 3.40425 3.75686 6.6007C3.18456 9.29986 3.8898 12.0097 5.69172 14.0354C6.57255 15.0255 7.07767 16.3326 7.07767 17.625V19.0312C7.07767 19.9668 7.69019 20.7617 8.53516 21.037C8.81303 22.6788 10.238 23.9999 11.9995 23.9999C13.7606 23.9999 15.186 22.6792 15.4639 21.037C16.3089 20.7617 16.9214 19.9668 16.9214 19.0312V17.6249C16.9214 16.33 17.4282 15.0387 18.3484 13.9889C19.6953 12.4523 20.437 10.4807 20.437 8.43745C20.437 3.11409 15.5644 -0.934077 10.1871 0.189329ZM11.9995 22.5937C11.0957 22.5937 10.3032 21.9718 10.0106 21.1359H13.9885C13.6959 21.9718 12.9034 22.5937 11.9995 22.5937ZM15.5152 19.0312C15.5152 19.4189 15.1998 19.7343 14.812 19.7343H9.18705C8.79935 19.7343 8.48392 19.4189 8.48392 19.0312V18.3281H15.5152V19.0312ZM17.2909 13.062C16.3103 14.1808 15.7069 15.5298 15.5538 16.9218H8.44539C8.29249 15.5291 7.69071 14.1668 6.74252 13.1008C5.24074 11.4125 4.65391 9.14963 5.13255 6.89241C5.69125 4.25738 7.83813 2.11683 10.4748 1.56591C14.9759 0.625266 19.0308 4.00552 19.0308 8.43745C19.0308 10.1396 18.4129 11.7819 17.2909 13.062Z"
          fill="var(--primary)"
        />
        <path
          d="M2.10938 8.4375H0.703125C0.314812 8.4375 0 8.75231 0 9.14062C0 9.52894 0.314812 9.84375 0.703125 9.84375H2.10938C2.49769 9.84375 2.8125 9.52894 2.8125 9.14062C2.8125 8.75231 2.49769 8.4375 2.10938 8.4375Z"
          fill="var(--primary)"
        />
        <path
          d="M2.40072 4.92101L1.40636 3.92665C1.13181 3.65205 0.686594 3.65205 0.412 3.92665C0.137406 4.20124 0.137406 4.64641 0.412 4.92101L1.40636 5.91537C1.68091 6.18996 2.12612 6.19001 2.40072 5.91537C2.67531 5.64077 2.67531 5.1956 2.40072 4.92101Z"
          fill="var(--primary)"
        />
        <path
          d="M2.40072 12.3641C2.12612 12.0896 1.68091 12.0896 1.40636 12.3641L0.412 13.3585C0.137406 13.6331 0.137406 14.0783 0.412 14.3529C0.686547 14.6275 1.13177 14.6275 1.40636 14.3529L2.40072 13.3585C2.67531 13.0839 2.67531 12.6387 2.40072 12.3641Z"
          fill="var(--primary)"
        />
        <path
          d="M23.2969 8.4375H21.8906C21.5023 8.4375 21.1875 8.75231 21.1875 9.14062C21.1875 9.52894 21.5023 9.84375 21.8906 9.84375H23.2969C23.6852 9.84375 24 9.52894 24 9.14062C24 8.75231 23.6852 8.4375 23.2969 8.4375Z"
          fill="var(--primary)"
        />
        <path
          d="M23.5882 3.92665C23.3137 3.65205 22.8685 3.65205 22.5939 3.92665L21.5995 4.92101C21.3249 5.1956 21.3249 5.64077 21.5995 5.91537C21.874 6.18991 22.3193 6.18996 22.5939 5.91537L23.5882 4.92101C23.8628 4.64641 23.8628 4.20124 23.5882 3.92665Z"
          fill="var(--primary)"
        />
        <path
          d="M23.5882 13.3585L22.5939 12.3641C22.3193 12.0896 21.8741 12.0896 21.5995 12.3641C21.3249 12.6387 21.3249 13.0839 21.5995 13.3585L22.5939 14.3529C22.8684 14.6274 23.3136 14.6275 23.5882 14.3529C23.8628 14.0783 23.8628 13.6331 23.5882 13.3585Z"
          fill="var(--primary)"
        />
      </g>
      <defs>
  ...
  Building: (
    ...
    >
      <path
        d="M19 21H5C4.44772 21 4 20.5523 4 20V10C4 9.44772 4.44772 9 5 9H19C19.5523 9 20 9.44772 20 10V20C20 20.5523 19.5523 21 19 21Z"
        stroke="var(--primary)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  Bell: `<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  Message: `<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
